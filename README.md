# Shardeum Token Creation Tool

A simple frontend tool to create tokens on the Shardeum (SHM) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Shardeum-Token-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your Shardeum Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Shardeum-Token-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your Shardeum wallet address for receiving fees. Also set fee in SHM that you want to charge
